...
const listBrand = [
  {
    ...
    description:
      "Evidentemente, a expansão dos mercados mundiais exige a precisão e a definição das condições inegavelmente apropriadas.",
  },
  {
  ...
  {
    href: "generation/canadian-smten",
    icon: <AssessmentIcon fontSize="small" />,
    title: "Canadian-SMTEN",
    media: null,
    params: "canadian-smten",
    url: null,
    description:
      "Evidentemente, a expansão dos mercados mundiais exige a precisão e a definição das condições inegavelmente apropriadas.",
  },
  ...
  {
    href: "generation/solarman-smart",
    icon: <AssessmentIcon fontSize="small" />,
    title: "Solarman SMART",
    media: null,
    params: "solarman-smart",
    url: null,
    description:
      "Evidentemente, a expansão dos mercados mundiais exige a precisão e a definição das condições inegavelmente apropriadas.",
  },
