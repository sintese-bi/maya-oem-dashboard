...
export const generation = {
  ...
  PATCH_GENERATION_REQUEST: "@api/PATCH_GENERATION_REQUEST",
  PATCH_GENERATION_SUCCESS: "@api/PATCH_GENERATION_SUCCESS",
  PATCH_GENERATION_FAILURE: "@api/PATCH_GENERATION_FAILURE",

  GET_PROJECTION_REQUEST: "@api/GET_PROJECTION_REQUEST",
  GET_PROJECTION_SUCCESS: "@api/GET_PROJECTION_SUCCESS",
  GET_PROJECTION_FAILURE: "@api/GET_PROJECTION_FAILURE",
};
